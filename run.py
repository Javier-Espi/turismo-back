...
from app.views import (
    alta_nuevo_alojamiento_form,
    eliminar_alojamiento,
    modificar_alojamiento_form,
    traer_json_alojamientos,
    traer_por_id_json_un_alojamiento,
)
...
app.route("/api/alojamientos/<int:id>", methods=["GET"])(
    traer_por_id_json_un_alojamiento
)
